...
// due time (most won't, since it's optional).
export default function TaskOverviewBar({ activeCount, highPriorityCount, dueSoonCount }) {
  return (
    <div className="flex items-center gap-4 rounded-2xl px-4 py-3 bg-[#171C2E]/80 border border-white/[0.06] backdrop-blur-xl mb-4">
      <div className="flex items-center gap-2">
        <span className="w-8 h-8 rounded-lg bg-[#F47A20]/10 flex items-center justify-center text-[#F47A20]">
          <ClipboardList size={14} />
        </span>
        <div>
          <p className="text-sm font-bold text-white leading-none">{activeCount}</p>
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          <p className="text-sm font-bold text-white leading-none">{highPriorityCount}</p>
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          <p className="text-sm font-bold text-white leading-none">{dueSoonCount}</p>
