    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-2">
          ...
          <p className="min-w-0 flex-1 truncate text-[13.5px] font-semibold text-white">{report.employee?.name ?? t("sup.unknown")}</p>
        ...
        <p className="mt-1 truncate text-[12.5px] text-[#C4C9D6]">
          {report.product?.name ?? t("rm.unknownItem")}
      ...
      <ChevronRight size={15} className="shrink-0 text-[#4C5266] transition-all duration-200 group-hover:translate-x-0.5 group-hover:text-[#F47A20] rtl-flip" />
    </button>
  );
}
