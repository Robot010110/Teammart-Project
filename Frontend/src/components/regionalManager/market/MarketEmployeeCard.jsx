...
const STATE = {
  ACTIVE: { label: "status.active", chip: "bg-emerald-500/12 text-emerald-400 ring-emerald-500/25", dot: "bg-emerald-400", icon: Store },
  ON_BREAK: { label: "emp.onBreak", chip: "bg-amber-500/12 text-amber-400 ring-amber-500/25", dot: "bg-amber-400", icon: Coffee },
  OFF_SHIFT: { label: "rm.offShift", chip: "bg-white/[0.06] text-[#8B93A8] ring-white/10", dot: "bg-[#4C5266]", icon: LogOut },
};
