...
// from their own market's employees, creates it. Uses the same
// Conversation/Message architecture as every other chat here (a real
// CUSTOM_GROUP conversation, not a separate system) — see
