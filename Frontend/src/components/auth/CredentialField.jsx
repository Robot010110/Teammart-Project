  ...
  return (
    <div>
      ...
      <div className="relative">
        <Icon size={16} className="absolute start-3.5 top-1/2 -translate-y-1/2 text-[#5C6479]" />
        <input
          type={type}
          value={value}
          ...
          autoCapitalize="none"
          autoCorrect="off"
          className={`w-full rounded-xl bg-white/[0.045] border ps-10 pe-3.5 py-3.5 text-[15px] text-white placeholder:text-[#4C5266] outline-none backdrop-blur-sm transition-all duration-200 ${
